...
(
    ...
    discount_rate float NULL COMMENT '할인율',
    coupon_applicable varchar(1) NULL COMMENT '쿠폰적용여부',
...
VALUES ('채식주의자','채식주의자 2007년도',20000,'교양',0.1,'Y'),
       ('소년이온다','소년이온다 2014년도',22000,'교양',0.5,'Y'),
       ('흰','흰 2016년도',10000,'자기계발',0.2,'N'),
       ('작별하지않는다','작별하지않는다 2021년도',15000,'수필',0.3,'N'),
       ('희랍어시간','희랍어 시간 2011년도',17000,'경제경영',0.1,'N')
;
